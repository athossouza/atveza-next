            ...
            <div className="flex h-full flex-col md:flex-row">
                ...
                <div className="flex-1 p-8 relative z-10 flex flex-col justify-center">
                    <h1 className="text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">
                        Inteligência Operacional <br /> e Suporte B2B
                    </h1>
                    <p className="mt-4 text-neutral-300 max-w-lg text-lg">
                        Transforme sua operação com o <strong>ATVEZA Method</strong>.
                        Maturidade, redução de custos e IA aplicada de verdade.
                    </p>
